...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/kempy007/checkers/checkers/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<CheckersQueryParamsResponse, RpcStatus>({
      path: `/kempy007/checkers/checkers/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/kempy007/checkers/checkers/stored_game
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/kempy007/checkers/checkers/stored_game`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/kempy007/checkers/checkers/system_info
   */
  querySystemInfo = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetSystemInfoResponse, RpcStatus>({
      path: `/kempy007/checkers/checkers/system_info`,
      method: "GET",
      format: "json",
      ...params,
    });
